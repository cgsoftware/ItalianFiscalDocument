    ...
    def genera(self, cr, uid, ids, context=None):
     if self.check_sottoscorta(cr, uid, ids, context):
      ...
      if 'cod_esenzione_iva' in Doc_obj._columns:
          record_doc['cod_esenzione_iva'] = TestaOrdine.cod_esenzione_iva.id
          record_doc['scad_esenzione_iva'] = TestaOrdine.scad_esenzione_iva
      if 'esenzione_conai' in Doc_obj._columns:
          record_doc['esenzione_conai'] = TestaOrdine.esenzione_conai.id
          record_doc['scad_esenzione_conai'] = TestaOrdine.scad_esenzione_conai
      ...
      for riga in righe:
        ...
        if 'cod_conai' in Riga_obj._columns:
            riga_doc['cod_conai'] = riga_ord.cod_conai.id
            riga_doc['peso_conai'] = riga_ord.product_id.production_conai_peso* riga.qty_ship
            riga_doc['prezzo_conai'] = riga_ord.prezzo_conai
